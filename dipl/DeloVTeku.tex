...
Glavni nov pojem, ki ga potrebujemo za nadaljne delo je pojem presečnega števila krivulj. Za dani preslikavi v ravnino, bi radi načrtno prešteli točke preseka njunih slik. S takšnih znanjem bomo kasneje lahko natančno povedali, kje bodo obstajali enakostranični trikotniki.
...
1; & \overrightarrow{s_f},\ \overrightarrow{s_g}\ \text{tvorita pozitivno orientirano bazo,}\\
-1; &\text{sicer}.
\end{cases}
\end{equation*}
...
Za lažji zapis in računanje, si v tem razdelku ravnino predstavljamo kot kompleksno ravnino. Hkrati dovolimo uporabo presečnega števila na paru usmerjenih ravninskih krivulj. Vrednost, ki jo tako presečno število predstavlja, je enako presečnemu številu preslikav $I \to \C$, ki se ??brez ustavljanja?? slikata v ti krivulji in za kateri velja, da sta sliki vrednosti $0$ začetni točki krivulj.
