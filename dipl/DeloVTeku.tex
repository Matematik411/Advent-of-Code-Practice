...
\filldraw (6.48, -3.65) circle [radius=1pt];
\node [right] at (6.48, -3.65) {$y_2$};
...
\begin{tikzpicture}
\draw [gray] plot [smooth cycle] coordinates {(0,0) (-2, -0.5) (-4, 0.5) (-5, -2) (-4, -3) (-2, -2.5) (-0.5, -3) (2, -4) (3.5, -2) (4, 0) (2, 1) (1, 0.5)};
\filldraw (0.423,-0.906) circle[radius=1pt];
\draw (0.423, -0.906) circle (1);
\draw (0,0) -- (0.164, -1.872) -- (0.996, -0.087) -- cycle;
\node [below] at (0.164, -1.872) {$y_0$};
\node [right] at (0.996, -0.087){$z_0$};
\node [above] at (0, 0) {$x$};

\draw (-7, 0) -- (-9.879, -2.416) -- (-6, -1.732) -- cycle;
\node at (-7.5, -1.5) {$T$};
\end{tikzpicture}
...
\begin{center}
\begin{tikzpicture}
\draw [gray] plot [smooth cycle] coordinates {(0,0) (-2*0.4, -0.5*0.4) (-4*0.4, 0.5*0.4) (-5*0.4, -2*0.4) (-4*0.4, -3*0.4) (-2*0.4, -2.5*0.4) (-0.5*0.4, -3*0.4) (2*0.4, -4*0.4) (3.5*0.4, -2*0.4) (4*0.4, 0) (2*0.4, 1*0.4) (1*0.4, 0.5*0.4)};
\draw (0,0) -- (0.164*0.72, -1.872*0.72) -- (0.996*0.72, -0.087*0.72) -- cycle;
\node [below] at (0.164*0.72, -1.872*0.72) {$y_1$};
\node [right] at (0.996*0.72, -0.087*0.72){$z_1$};
\node [above] at (0, 0) {$x$};

\draw [gray] plot [smooth cycle] coordinates {(5+0,0) (5+-2*0.4, -0.5*0.4) (5+-4*0.4, 0.5*0.4) (5+-5*0.4, -2*0.4) (5+-4*0.4, -3*0.4) (5+-2*0.4, -2.5*0.4) (5+-0.5*0.4, -3*0.4) (5+2*0.4, -4*0.4) (5+3.5*0.4, -2*0.4) (5+4*0.4, 0) (5+2*0.4, 1*0.4) (5+1*0.4, 0.5*0.4)};
\draw (5+0,0) -- (5+-2, -0.8) -- (5+0.234, -1.122) -- cycle;
\node [below] at (5+-2, -0.8) {$y_2$};
\node [right] at (5+0.234, -1.122) {$z_2$};
\node [above] at (5+0, 0) {$x$};

\draw [gray] plot [smooth cycle] coordinates {(10+0,0) (10+-2*0.4, -0.5*0.4) (10+-4*0.4, 0.5*0.4) (10+-5*0.4, -2*0.4) (10+-4*0.4, -3*0.4) (10+-2*0.4, -2.5*0.4) (10+-0.5*0.4, -3*0.4) (10+2*0.4, -4*0.4) (10+3.5*0.4, -2*0.4) (10+4*0.4, 0) (10+2*0.4, 1*0.4) (10+1*0.4, 0.5*0.4)};
\draw (10+1.6, 0) -- (10+-2, -0.8) -- (10+1.686, -1.962) -- cycle;
\node [below] at (10+-2, -0.8) {$y_3$};
\node [right] at (10+1.686, -1.962) {$z_3$};
\node [above] at (10+1.6, 0) {$x_3$};
\end{tikzpicture}
\end{center}

Skupna pot točke $z$ je tako sestavljena iz treh zveznih lokov ($z_0-z_1-z_2-z_3$). Ker je $yz$ (ob koncu $y_3z_3$) najdaljša stranica trikotnika, po podobnem premisleku kot prej sledi, da mora $z_3$ ležati na $J$ ali v neomejeni komponenti $\R^2 \setminus J$. Želeni rezultat sledi.
\endproof
...
\]
Primer vidimo na sliki \ref{fig:izracun}.

\begin{figure}
\centering
\begin{tikzpicture}
\draw[blue, ->] (0, 0) -- (2, 2) -- (4, 0) -- (6, 2) -- (8, 0) -- (10, 2) node[pos=1, right] {$f$};
\draw[gray, ->] (-0.5, 1) -- (1, -0.5) -- (1, 1) -- (3.5, 0.5) -- (4, 0) -- (5, 1) -- (6.75, 1.25) -- (7.5, 0.5) -- (8.5, 1.25) -- (10.5, 0.5) node[pos=1, below] {$g$};
\draw[thick, black] (3.5, 0.5) -- (4, 0) -- (5, 1) node[pos=0.2, above=5] {$0$};
\draw[thick, black] (6.75, 1.25) -- (7.5, 0.5);
\node at (6.5, 0.75) {$+1$};
\filldraw (0.25, 0.25) circle (1pt) node[left = 5] {$-1$};
\filldraw (1, 1) circle (1pt);
\node at (0.8, 1.2) {$0$};
\filldraw (9.045, 1.045) circle (1pt) node[above = 3] {$-1$};
\node at (12, 1) {$\ind{f}{g} = -1$}; 
\end{tikzpicture}
\caption{Primer izračuna presečnega števila.}
\label{fig:izracun}
\end{figure}
...
\centering
\begin{tikzpicture}
\draw (0, 0) -- (0, 5) node[pos = 0.5, right] {$A$};
\draw[blue] (0, 0) -- (4.330, 2.5) -- (0, 5);
\draw[blue] (0, 0) -- (-4.330, 2.5) -- (0, 5);
\node[blue] at (2.85, 4) {$\R^2 \setminus D_A$};
\end{tikzpicture}
...
Zato obstajata para $\{P, Q\} \neq \{S, T\}$ točk na $J$ z enako sliko pri preslikavi $f$. Točke v teh parih so oglišča pravokotnika na $J$.
...
\geslo{connected component}{komponenta za povezanost}
\geslo{embedding}{vložitev}
\geslo{endpoint}{končna točka}
\geslo{equilateral triangle}{enakostranični trikotnik}
\geslo{homotopy}{homotopija}
\geslo{intersection number}{presečno število}
\geslo{juncture}{stičišče}
\geslo{leg}{krak}
\geslo{line segment}{daljica}
\geslo{M\"obius strip}{M\"obiusov trak}
\geslo{origin}{izhodišče}
\geslo{piecewise linear function}{kosoma linearna preslikava}
\geslo{simplicial approximation}{simplicialna aproksimacija}
\geslo{symmetry}{simetrija}
\geslo{triod}{trioda}
