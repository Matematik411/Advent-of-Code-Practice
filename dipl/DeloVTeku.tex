...
\begin{minipage}{0.3\textwidth}
	\begin{tikzpicture}
	\draw [gray] plot [smooth cycle] coordinates {(0,0) (-2*0.4, -0.5*0.4) (-4*0.4, 0.5*0.4) (-5*0.4, -2*0.4) (-4*0.4, -3*0.4) (-2*0.4, -2.5*0.4) (-0.5*0.4, -3*0.4) (2*0.4, -4*0.4) (3.5*0.4, -2*0.4) (4*0.4, 0) (2*0.4, 1*0.4) (1*0.4, 0.5*0.4)};
	\draw (0,0) -- (-2, -0.8) -- (0.234, -1.122) -- cycle;
	\node [below] at (-2, -0.8) {$y_2$};
	\node [right] at (0.234, -1.122) {$z_2$};
	\node [above] at (0, 0) {$x$};
	\end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}{0.35\textwidth}
	\begin{tikzpicture}
	\draw [gray] plot [smooth cycle] coordinates {(0,0) (-2*0.4, -0.5*0.4) (-4*0.4, 0.5*0.4) (-5*0.4, -2*0.4) (-4*0.4, -3*0.4) (-2*0.4, -2.5*0.4) (-0.5*0.4, -3*0.4) (2*0.4, -4*0.4) (3.5*0.4, -2*0.4) (4*0.4, 0) (2*0.4, 1*0.4) (1*0.4, 0.5*0.4)};
	\draw (1.6, 0) -- (-2, -0.8) -- (1.686, -1.962) -- cycle;
	\node [below] at (-2, -0.8) {$y_3$};
	\node [right] at (1.686, -1.962) {$z_3$};
	\node [above] at (1.6, 0) {$x_3$};
	\end{tikzpicture}
\end{minipage}
\caption{Premiki trikotnika v dokazu trditve \ref{trd:trik_poljuben}}
\label{fig:trik_premiki}
\end{figure}
